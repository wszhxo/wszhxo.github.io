...
![关于HashMap几个刁钻的面试题，第四个我就跪了](https://imgconvert.csdnimg.cn/aHR0cDovL3AxLnBzdGF0cC5jb20vbGFyZ2UvcGdjLWltYWdlLzViYTk2OTY4N2IxYzQ1OTc4NDA3ZWU1YzYyN2NjMjUx?x-oss-process=image/format,png)

 

JDK 1.8 中，采用Node + CAS + Synchronized来保证并发安全。取消类 Segment，直接用 table 数组存储键值对；当 HashEntry 对象组成的链表长度超过 TREEIFY_THRESHOLD 时，链表转换为红黑树，提升性能。底层变更为数组 + 链表 + 红黑树。

![关于HashMap几个刁钻的面试题，第四个我就跪了](https://imgconvert.csdnimg.cn/aHR0cDovL3AxLnBzdGF0cC5jb20vbGFyZ2UvcGdjLWltYWdlL2VjYWZjMDliNDljNDQ4ZmJhZGMzZTNmNGFjMGNjYjk4?x-oss-process=image/format,png)
